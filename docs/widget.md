...
To allow users to buy crypto, you need an API key. To get an API key, fill in <a href="https://share-eu1.hsforms.com/1c4qtZQxJSuONbQquXI9tdgfe2vw" target='_blank' >our onboarding form.</a>
...
If you want to receive a referral fee for every transaction done by users coming from your website, <a href="https://share-eu1.hsforms.com/1c4qtZQxJSuONbQquXI9tdgfe2vw" target='_blank' >fill in our onboarding form to receive your API key</a> and then add your API key to the link as follows: `https://widget.onramper.com?apiKey=theAPIkeyyoureceived`.
...
| ----------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| apiKey            | Alphanumeric string                                                      | `?apiKey=yourAPIkey` <a href="https://share-eu1.hsforms.com/1c4qtZQxJSuONbQquXI9tdgfe2vw" target='_blank' >(fill in our onboarding form to receive your API key)</a> | Not set              |
...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| API_KEY           | string?                                                                                                                                                           | `"yourAPIkey"` <a href="https://share-eu1.hsforms.com/1c4qtZQxJSuONbQquXI9tdgfe2vw" target='_blank' >(fill in our onboarding form to receive your API key)</a> | undefined            |
...
| Name              | Type                                                                                                                                                              | Example                                                                                                                                                                                                                                                   | Default value |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| API_KEY           | string?                                                                                                                                                           | `Onramper.initialize("#id", {API_KEY:"YourAPIkey"})` <a href="https://share-eu1.hsforms.com/1c4qtZQxJSuONbQquXI9tdgfe2vw" target='_blank' >(fill in our onboarding form to receive your API key)</a> | undefined     |
